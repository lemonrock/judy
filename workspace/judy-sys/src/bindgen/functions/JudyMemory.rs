...
extern "C"
{
	pub fn JudyFree(arg1: Pvoid_t, arg2: Word_t);
	pub fn JudyFreeVirtual(arg1: Pvoid_t, arg2: Word_t);
	pub fn JudyMalloc(arg1: Word_t) -> Word_t;
	pub fn JudyMallocVirtual(arg1: Word_t) -> Word_t;
}
